;; timelock-core
;; 
;; This contract provides a flexible and secure timelock mechanism for token distribution and governance.
;; It enables time-based vesting schedules, controlled token releases, and programmatic fund management
;; with configurable release conditions and granular access controls.
